    ...
    <div id="sub-body">
      ...
      <div class="body-contents container">
        ...
        <ul class="body-con-menu-hot clearfix">
          <li><a href="/menu/hotdog">Hotdog</a></li>
          <li><a href="/menu/coffee">Coffee</a></li>
          <li><a href="/menu/beverage" class="redbutton">Beverage</a></li>
          <li><a href="/menu/sidemenu">Side Menu</a></li>
        </ul>
        <div class="body-con-box-hot">
        	<ul>
        		<li>
        			<img src="/images/menu/beverage/beverage1.jpg" alt="">
        			<h3>오렌지에이드</h3>
        			<p>ORANGE ADE</p>
        			<button>구매하기</button>
        		</li>
        		<li>
        			<img src="/images/menu/beverage/beverage2.jpg" alt="">
        			<h3>딸기 스무디</h3>
        			<p>STRAWBERRY SMOOTHIE</p>
        			<button>구매하기</button>
        		</li>
        		<li>
        			<img src="/images/menu/beverage/beverage3.jpg" alt="">
        			<h3>키위 스무디</h3>
        			<p>KIWI SMOOTHIE</p>
        			<button>구매하기</button>
        		</li>
        		<li>
        			<img src="/images/menu/beverage/beverage4.jpg" alt="">
        			<h3>레몬에이드</h3>
        			<p>LEMON ADE</p>
        			<button>구매하기</button>
        		</li>
        		<li>
        			<img src="/images/menu/beverage/beverage5.jpg" alt="">
        			<h3>망고 스무디</h3>
        			<p>MANGO SMOOTHIE</p>
        			<button>구매하기</button>
        		</li>
        		<li>
        			<img src="/images/menu/beverage/beverage6.jpg" alt="">
        			<h3>자몽에이드</h3>
        			<p>GRAPEFRUIT ADE</p>
        			<button>구매하기</button>
        		</li>
        		<li>
        			<img src="/images/menu/beverage/beverage7.jpg" alt="">
        			<h3>청포도 에이드</h3>
        			<p>GREENGRAPE ADE</p>
        			<button>구매하기</button>
        		</li>
        		<li>
        			<img src="/images/menu/beverage/beverage8.jpg" alt="">
        			<h3>블루베리 스무디</h3>
